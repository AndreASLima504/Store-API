...
export class migration1727669082496 implements MigrationInterface {
    name = 'migration1727669082496'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("CREATE TABLE `sale` (`id` varchar(36) NOT NULL, `userId` varchar(255) NOT NULL, `value` int NOT NULL, `createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), PRIMARY KEY (`id`)) ENGINE=InnoDB");
        await queryRunner.query("CREATE TABLE `product_to_sale` (`productId` varchar(255) NOT NULL, `saleId` varchar(255) NOT NULL, `quantity` int NOT NULL, `subtotal` int NOT NULL, PRIMARY KEY (`productId`, `saleId`)) ENGINE=InnoDB");
        ...
        await queryRunner.query("ALTER TABLE `product_to_sale` ADD CONSTRAINT `FK_f9e2032cee5b52cf7201e2a6e5d` FOREIGN KEY (`saleId`) REFERENCES `sale`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION");
        await queryRunner.query("ALTER TABLE `product_to_sale` ADD CONSTRAINT `FK_3ca965bd5c61bb7f1777088536b` FOREIGN KEY (`productId`) REFERENCES `product`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION");
        await queryRunner.query("ALTER TABLE `product` ADD CONSTRAINT `FK_ff0c0301a95e517153df97f6812` FOREIGN KEY (`categoryId`) REFERENCES `category`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION");
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query("ALTER TABLE `product` DROP FOREIGN KEY `FK_ff0c0301a95e517153df97f6812`");
        await queryRunner.query("ALTER TABLE `product_to_sale` DROP FOREIGN KEY `FK_3ca965bd5c61bb7f1777088536b`");
        await queryRunner.query("ALTER TABLE `product_to_sale` DROP FOREIGN KEY `FK_f9e2032cee5b52cf7201e2a6e5d`");
